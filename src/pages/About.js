...
export default function About() {
  ...
  <div className="member">
    ...
    <p>Phone: <a href="tel:+996702514897">+996702514897</a></p>
  ...
  <div className="member">
    ...
    <p>Instagram: <a href="https://www.instagram.com/aigul.baigazieva/"><i className="fab fa-instagram"></i></a></p>
  </div>
  <div className="member">
    ...
    <p>Phone: <a href="tel:+1234567890">+1234567890</a></p>
    <p>Instagram: <a href="https://www.instagram.com/samira.salmahunova/"><i className="fab fa-instagram"></i></a></p>
  </div>
</div>
    </div>
  );
